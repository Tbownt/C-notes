...
namespace HelloWorld
{
    internal class Program
    {
        static void Main (string[] args)
        {
            ...
            // Console.WriteLine(myGroceryArray[2]); //Error

            // string[] mySecoundGroceryArray = ["Apples", "Eggs"];
            // Console.WriteLine(mySecoundGroceryArray[0]);
            // Console.WriteLine(mySecoundGroceryArray[1]);
